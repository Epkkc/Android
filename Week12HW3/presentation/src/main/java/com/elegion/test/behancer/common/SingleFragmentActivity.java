...
public abstract class SingleFragmentActivity extends AppCompatActivity
        implements SwipeRefreshLayout.OnRefreshListener, RefreshOwner, RefreshCallbackInterface {
    ...
    public void onRefresh() {
        ...
        if (fragment instanceof Refreshable) {
            ((Refreshable) fragment).onRefreshData(this::callback);
        } else {
    ...
    @Override
    public void callback(boolean refreshState) {
